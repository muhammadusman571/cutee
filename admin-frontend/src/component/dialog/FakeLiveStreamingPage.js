...
const FakeLiveStreamingPage = (props) => {
  ...
  useEffect(() => {
    dispatch(getFakeUserList());
    dispatch(getLiveStreamingVideo());
  }, [dispatch]);
  ...
  const detail = JSON.parse(sessionStorage.getItem("liveStreamingVideo"));
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      navigate("/admin/fakeLiveStreaming");
    }, 3000);
  };
