...
router.get("/getVideo", VideoController.index);

// get user wise video list
router.get("/getRelite", checkAccessWithKey(), VideoController.getVideo);

// get following feed - videos of followed users if userId given, else all videos
router.get(
  "/getFollowingVideos",
  checkAccessWithKey(),
  VideoController.getFollowingVideos,
);
