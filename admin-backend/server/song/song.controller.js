...
exports.index = async (req, res) => {
  try {
    ...
    if (!song) return res.status(200).json({ status: false, message: "No data found!" });
...
exports.store = async (req, res) => {
  try {
    if (!req.body.title || !req.body.singer || !req.files.song || !req.files.image) {
...
exports.update = async (req, res) => {
  try {
    ...
    if (!songs) return res.status(200).json({ status: false, message: "Song does not Exist!" });
