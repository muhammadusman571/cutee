...
exports.store = async (req, res) => {
  try {
    if (!req.body.validity || !req.body.validityType || !req.body.dollar || !req.body.rupee || !req.body.productKey) return res.status(200).json({ status: false, message: "Invalid Details!" });
