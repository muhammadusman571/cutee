...
const userSchema = new mongoose.Schema(
  {
    ...
    coverImage: {
      type: String,
      default: `${config.baseURL}storage/coverImage.png`,
    },
    ...
    onlineStatusDate: { type: String, default: null },
    ...
    isOfficialFrame: { type: Boolean, default: false },
    isUploadTag: { type: Boolean, default: false },
    isUploadBadge: { type: Boolean, default: false },
    uploadType: {
      type: String,
    ...
    uploadTags: [{ type: mongoose.Schema.Types.ObjectId, ref: "UploadTag" }],

    uploadBadges: [
      { type: mongoose.Schema.Types.ObjectId, ref: "UploadBadge" },
    ],
